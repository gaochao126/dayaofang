	...
	public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			for (int i = 0; i < files.getCount(); i++) {
				...
				if ("1".equals(type)) {
					fileName = "head_" + customer.getUser_id() + "." + file.getFileExt();
				} else if ("2".equals(type)) {
					fileName = "auth_" + customer.getUser_id() + "_" + Util.getUniqueSn() + "." + file.getFileExt();
				} else if ("3".equals(type)) {
					fileName = "symptoms_" + customer.getUser_id() + "_" + Util.getUniqueSn() + "." + file.getFileExt();
				}
