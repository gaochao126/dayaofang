...
public class SmsService {
	 ...
	 * @return
	 */
	public SmsRespDto sendCode(String phone) {
	 ...
	 * @return
	 */
	public SmsRespDto sendCode(String phone, String code) {
		SmsCheckService.instance().setCode(phone, code);
		return sendSms(phone, "6994", "#code#=" + code);
	}
	 ...
	 * @return
	 */
	public SmsRespDto sendSms(String phone, String templateId, String args) {
	...
	public static void main(String[] args) {
		SmsRespDto resp = SmsService.instance().sendSms("18223506390", "6994", "#code#=123456");
